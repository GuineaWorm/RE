...
def checkTools():
    countOne = Items.BackpackCount(0x1EB8,-1)
    while countOne < 3:
        Misc.Pause(1100)
        tinkerTool = Items.FindByID(0x1EB8,-1,Player.Backpack.Serial)
        Misc.Pause(100)
    ...
    countTwo = Items.BackpackCount(0x0FBB,-1)
    while countTwo < 3:
        Misc.Pause(1100)
        tinkerTool = Items.FindByID(0x0FBB,-1,Player.Backpack.Serial)
        Misc.Pause(100)
        Items.UseItem(tinkerTool)
        Gumps.WaitForGump(949095101, 10000)
